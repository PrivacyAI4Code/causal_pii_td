...
CONFIG_FILE="codellama_CodeLlama-13b-hf_fim.yaml"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python run.py --config configs/$CONFIG_FILE --task finetune
CUDA_VISIBLE_DEVICES=0,1,2,3 python run.py --config configs/$CONFIG_FILE --task post_eval
CUDA_VISIBLE_DEVICES=0,1,2,3 python run.py --config configs/$CONFIG_FILE --task post_attack
