...
CONFIG_FILE="Qwen_Qwen2.5-Coder-14B_fim.yaml"
...
CUDA_VISIBLE_DEVICES=2,3 python run.py --config configs/$CONFIG_FILE --task finetune
CUDA_VISIBLE_DEVICES=2,3 python run.py --config configs/$CONFIG_FILE --task post_eval
CUDA_VISIBLE_DEVICES=2,3 python run.py --config configs/$CONFIG_FILE --task post_attack
