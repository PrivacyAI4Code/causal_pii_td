...
CUDA_VISIBLE_DEVICES=4 python run.py --config configs/Qwen_Qwen2.5-Coder-14B_fim.yaml --task post_attack
CUDA_VISIBLE_DEVICES=4 python run.py --config configs/codellama_CodeLlama-13b-hf_fim.yaml --task post_attack
CUDA_VISIBLE_DEVICES=4 python run.py --config configs/bigcode_starcoder2-15b_fim.yaml --task post_attack
