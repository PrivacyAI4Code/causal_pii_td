...
CONFIG_FILE="Qwen_Qwen2.5-Coder-7B_fim.yaml"
...
CUDA_VISIBLE_DEVICES=0 python run.py --config configs/$CONFIG_FILE --task finetune
CUDA_VISIBLE_DEVICES=0 python run.py --config configs/$CONFIG_FILE --task post_eval
CUDA_VISIBLE_DEVICES=0 python run.py --config configs/$CONFIG_FILE --task post_attack
